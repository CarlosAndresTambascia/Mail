...
public class MessageControllerTest {
	...
	public void getAllMessagesInboxOkTest() throws Exception {
		...
		mockMvc.perform(
				get("/api/message/inbox").header("sessionId", this.sessionId).header("usuario", reciverFake.getName())
	...
	public void getAllMessagesOutboxOkTest() throws Exception {
		...
		this.message = messageRepository.save(message);
		mockMvc.perform(get("/api/message/outbox").header("sessionId", this.sessionId).header("usuario",
				remittentFake.getName())
	...
	@Test
	public void getAllMessagesOutboxBadTest() throws Exception {
	...
	@Test
	public void dropMessageBad() throws Exception {
		this.sessionId = this.sessionData.addSession(reciverFake);
		messageRepository.save(message);
		URL url = Resources.getResource("dropMessage.json");
		String json = Resources.toString(url, Charsets.UTF_8);
		
		mockMvc.perform(patch("/api/message/1").contentType(MediaType.APPLICATION_JSON_UTF8).content(json));

	}
	
	@Test
	public void dropMessageOk() throws Exception {
		this.sessionId = this.sessionData.addSession(reciverFake);
		messageRepository.save(message);
		URL url = Resources.getResource("dropMessage.json");
		String json = Resources.toString(url, Charsets.UTF_8);
	...
	public void trashokTest() throws Exception {
		...
		mockMvc.perform(
				...
				get("/api/message/trash").header("sessionId", this.sessionId).header("user", reciverFake.getName()))
